...
[Diagram: Stack growing into global memory causing silent corruption]
...
[Diagram: Fragmented heap with unusable gaps]
...
[Diagram: Buffer overrun overwriting adjacent memory]
...
```
[Diagram: DMA writing to memory while CPU reads from it]
...
[Diagram: Stack collision with DMA buffer affecting control loop]
