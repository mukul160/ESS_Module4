...
[Diagram: Stack growth with nested function calls, interrupts, and context switching]
...
[Diagram: Heap growth and fragmentation illustration]
...
[Diagram: DMA transferring data to memory while CPU accesses same memory]
...
[Diagram: Shared buffer accessed by main loop and interrupt with volatile]
...
[Diagram: SRAM showing stack growing downward, heap growing upward, DMA buffers in between]
